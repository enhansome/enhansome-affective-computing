...
* [Speech-Emotion-Analyzer](https://github.com/MITESHPUTHRANNEU/Speech-Emotion-Analyzer) ⭐ 1,410 | 🐛 23 | 🌐 Jupyter Notebook | 📅 2023-02-07, The neural network model is capable of detecting eight different male/female emotions from audio speeches. (Deep Learning, Python)
...
* [Emotion](https://github.com/petercunha/Emotion) ⭐ 477 | 🐛 15 | 🌐 Python | 📅 2021-12-30, Recognizes human faces and their corresponding emotions from a video or webcam feed. Powered by OpenCV and Deep Learning.
